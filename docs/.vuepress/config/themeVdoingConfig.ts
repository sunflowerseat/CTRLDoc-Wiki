...
export default <VdoingThemeConfig>{
  ...
  repo: "sunflowerseat/CTRLDoc-Wiki", // 导航栏右侧生成Github链接
    ...
    icons: [
      {
        ...
        title: "GitHub",
        link: "https://github.com/sunflowerseat",
      },
      {
        iconClass: "icon-youjian",
        title: "Send Email",
        link: "sunflowseat@gmail.com",
      },
    ],
  },
  footer: {
    ...
    copyrightInfo: `
      <a href="http://beian.miit.gov.cn/" target="_blank">粤ICP备88888888号-1</a>
    `, // 博客版权信息，支持a标签
  },
};
